...
- Model: sentence-transformers/all-MiniLM-L6-v2 (fast & small, good for CPU)
...
3) run: python giveinfonew_bot_semantic_improved.py
...
TOP_K = int(os.getenv('TOP_K', '5'))  # how many candidates to retrieve from FAISS
EMB_DIR = os.getenv('EMB_DIR', './embeds')
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text('Xin chào! Tôi là NewsBot — semantic search (improved). Gõ chủ đề để tìm bài.')
